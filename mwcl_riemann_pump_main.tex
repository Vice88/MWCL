...
The measurement yields an output power of 1.375 W for Vdd = 5V, which illustrates the possibility to increase the output power to several watts by applying voltages of up to 28V.
