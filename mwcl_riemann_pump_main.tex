...
First of all the new concept of the Riemann Pump shows the feasibility to improve the data rate.
An architecture (schematic) is elaborated and also implemented and assembled to prove this concept.
At last the realized demonstrator verify the concept with measurement results.
