...
The measurement results have verified the concept resulting in a synthesized triangular signal controlled by a 200 Mbps input control bitstream.
...
\IEEEPARstart{T}{he} immense demand on high data rates forces researchers to investigate new technologies to improve the data rates of conventional concepts.
