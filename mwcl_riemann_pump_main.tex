...
For each sampling point the slope that minimizes the error between the sampled desired and the synthesized signal is chosen, which is illustrated as the dashed line.
