...
Further, the \gls{gan} \gls{hemt} technology provides high-switching frequencies to ensure an oversampling ratio of 5 for a wide baseband bandwidth. %signal.
...
The presented concept of the Riemann Pump in \gls{gan} technology shows the potential to reach a signal power of up to 20 W while improving the data rate for base station transmitters.
...
The measurement results in Figure \ref{fig:meas_Output_CLoad_100M_1io_3io} present the output of the digital-to-analog conversion, which could drive a co-integrated \gls{pa} to gain a power of 20 W.
