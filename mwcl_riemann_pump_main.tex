...
For the digital switching of the \gls{gan} power transistors a \gls{mmic} is used which has implemented a proper driver circuit \cite{MaroldtBruecknerQuayEtAl2014}.
...
The potential of the chosen technology promises to cover even higher frequencies, the concept integrated in a \gls{mmic}, to satisfy the condition for the new mobile communication standards.
